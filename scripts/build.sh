...
if [ "$(uname -m)" = "aarch64" ]; then
    CUR_VERSION='centos:7.6.1810'
    NEW_VERSION='centos@sha256:df89b0a0b42916b5b31b334fd52d3e396c226ad97dfe772848bdd6b00fb42bf0'

    sed -i "${DOCKERFILE}" -e "s/${CUR_VERSION}/${NEW_VERSION}/g"
fi
